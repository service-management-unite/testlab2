...
[2.7 Locate your login details and log in to Watson for AIOps Event Manager](http://localhost:3000/testlab2/labs/watson-aiops/installation/#27-locate-your-login-details-and-log-in-to-watson-for-aiops-event-manager)
